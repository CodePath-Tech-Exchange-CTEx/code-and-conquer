...
#         print("Database empty. Generating AI matches...")
#         ai_generated_data = generate_recommended_groups_data(interests)
        
#         # Save that AI response back into the database
#         save_ai_generated_groups(user_id, ai_generated_data)
        
#         # Now that it's saved, pull it from the DB to display
#         return get_study_group_recommendations(user_id)
